            ...
            this.$store.dispatch('user/login', this.loginForm)
              .then(() => {
                this.$store.dispatch('user/getInfo', this.loginForm)
                  .then(() => {
                    if (this.checkRole(['client']) === true) {
                      this.$router.push({ path: '/client', query: this.otherQuery }, onAbort => {});
                      this.loading = false;
                    } else if (this.checkRole(['admin']) === true) {
                      this.$router.push({ path: '/admin', query: this.otherQuery }, onAbort => {});
                      this.loading = false;
                    }
                  });
              })
