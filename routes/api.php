...
Route::namespace('Api')->group(function() {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::post('customer/create-subscription', 'CustomerController@createSubscription');
        Route::post('customer/cancel-subscription', 'CustomerController@cancelSubscription');
        Route::post('customer/get-subscription', 'CustomerController@getSubscription');
        Route::post('customer/re-subscription', 'CustomerController@reSubscription');
        Route::post('customer/setup-done', 'CustomerController@setupDone');
...
Route::get('/messages/admin', 'ChatsController@fetchMessagesByUserId');
Route::post('/messages', 'ChatsController@sendMessage');
Route::post('/messages/admin', 'ChatsController@sendMessageToUser');
Route::get('/users', 'ChatsController@getAllClients'); //get all clients info
Route::post('/messages/setReaded', 'ChatsController@setMessagesReaded');
Route::get('/messages/unreadedNumber', 'ChatsController@getNumberUnreaded');
